        ...
        <div class="summary-card">
            ...
            <div class="summary-card-body">
                ...
                <form method="POST" action="https://checkout.flutterwave.com/v3/hosted/pay">
                    <input type="hidden" name="public_key" value="FLWPUBK_TEST-1af35afac90ba6ea77041622a8f3cc55-X" />
                    ...
                    <input type="hidden" name="redirect_url" value="https://32c1-197-243-40-122.ngrok-free.app/bike_scooters/userdash/processPayment.php?booking_id=<?= htmlspecialchars($booking['booking_id']); ?>" />
