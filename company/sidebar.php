...
<div class="col-md-3 col-lg-2 px-0 position-fixed h-100 bg-dark shadow-sm sidebar" id="sidebar">
    ...
    <div class="list-group rounded-0">
        ...
        <div id="bike-scooter-collapse" class="collapse">
            <a href="regbike.php" class="list-group-item list-group-item-action border-0 pl-4">Add Vehicles</a>
            <a href="viewvehicle.php" class="list-group-item list-group-item-action border-0 pl-4">View Vehicles</a>
        </div>
        <a href="viewmybooking.php" class="list-group-item list-group-item-action border-0 align-items-center">
            <span class="fas fa-book"></span> 
            <span class="ml-2">Manage Booking</span>
        </a>
        <a href="edit_vendor.php" class="list-group-item list-group-item-action border-0 align-items-center">
